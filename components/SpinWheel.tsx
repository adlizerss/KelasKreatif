    ...
    <div className="animate-in fade-in duration-500 pb-40 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 order-1 lg:order-2">
          <div className="bg-white dark:bg-slate-900 rounded-3xl pt-16 pb-24 px-6 lg:px-12 relative overflow-hidden shadow-2xl flex flex-col items-center justify-center min-h-[600px] border border-rose-100 dark:border-rose-900/30">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-rose-50 via-pink-50 to-orange-100 dark:from-slate-800 dark:via-slate-900 dark:to-slate-950"></div>
